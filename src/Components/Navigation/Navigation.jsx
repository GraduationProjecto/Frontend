  ...
  return <>
    <nav>
      <div className="container">
        <div className="text">
          <h1>
          Sell Your Car In Egypt. Fast          </h1>
          <p>
          Free & Just in One minute Choose your car information → Upload you car images → Get interested calls instantly          </p>
        </div>
        <ul className='list-unstyled ulNav'>
          <li className="navlink link1 liNav">
            <NavLink activeclassname='active' to={'sell-your-car'} className='text-decoration-none aNAv'>
